...
export const NODE_NAME = 'NodePage';
...
export const TEMPLATES_SETTING_SINGLE_PATH = '/templates/settings/:id/:title';
export const TEMPLATES_SETTING_SINGLE_NAME = 'template_single_page';
