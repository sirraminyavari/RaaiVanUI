(function () {
    if (((window.ReportOptions || {}).KW || {}).KnowledgeAdminsReport) return;
    window.ReportOptions = window.ReportOptions || {};
    window.ReportOptions.KW = window.ReportOptions.KW || {};

    window.ReportOptions.KW.KnowledgeAdminsReport = function (containerDiv, params, done) {
    ...
    ReportOptions.KW.KnowledgeAdminsReport.prototype = {
